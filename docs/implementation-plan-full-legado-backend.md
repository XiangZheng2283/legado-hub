...
> **For agentic workers:** REQUIRED SUB-SKILL: Use execution checkpoints task-by-task. Do not treat this as a small patch. Each milestone must ship working API, working Chinese UI, and API/UI simulation evidence before moving on.
