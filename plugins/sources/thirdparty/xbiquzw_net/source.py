...
class Source:
    ...
    async def toc(self, ctx, toc_url: str):
        ...
        for _ in range(200):
            ...
            for a in links:
                ...
                if not href or not title or not href.endswith(".html") or chapter_url in seen:
                    continue
    ...
    def _extract_chapter_index(self, title: str, href: str) -> int:
    ...
    def _clean_chapter_content(self, html: str) -> str:
        ...
        for div in soup.find_all("div"):
            ...
            if len(text) < 80 and any(kw in text for kw in ["广告", "声明", "本章结束", "返回目录", "加入书签", "推荐", "最新网址", "章节内容缺失", "章节不存在", "笔尖中文", "xbiquzw"]):
                div.decompose()
